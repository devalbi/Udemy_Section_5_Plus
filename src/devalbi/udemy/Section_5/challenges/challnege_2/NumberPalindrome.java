...
public class NumberPalindrome {
    ...
    public static void main(String[] args) {
        ...
        n.isPalindrome(-1221);
        n.isPalindrome(707);
        n.isPalindrome(11212);

    }

    public static boolean isPalindrome(int number) {
        //TODO Run loop, pull last digit, parse to string and add it.
        //Once complete, parse back to int and compare
        if(number < 0) {
            number *= -1;
        }
        ...
        while (newNumber != 0) {
            reverseNumber += String.valueOf(newNumber % 10);
            newNumber/=10;
            continue;
        }

        if (Integer.parseInt(reverseNumber) == number) {
            System.out.println("Reversed number = " + reverseNumber + ", Number = " + number +" \n" +
                    "This is a Palindrome");
            return true;
        }

        System.out.println("Reversed number = " + reverseNumber + ", Number = " + newNumber +" \n" +
